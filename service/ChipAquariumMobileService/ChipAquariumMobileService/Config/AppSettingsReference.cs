...
{
    public class AppSettingsReference
    {
        ...
        public static TimeSpan ReceiveSpanPermissibleRangeTime
        {
            get { return TimeSpan.Parse(items["ReceiveSpanPermissibleRangeTime"]); }
        }
    }
}