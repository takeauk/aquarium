...
GPIO_PIN_NUMBER = int(sys.argv[2])
...
MSG_TXT = "{\"device\": \"%s\",\"measurementTarget\": \"level\",\"isOver\": \"%s\"}"
    ...
    try:
        ...
        while True:
            ...
            if MESSAGE_SWITCH:
                ...
                isOver = sensor.read()
                msg_txt_formatted = MSG_TXT % (DEVICE_NAME, "true" if isOver else "false")
...
def usage():
    print ( "Usage: iothub_client_sam/ple.py -p <protocol> -c <connectionstring>" )
